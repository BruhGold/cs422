      ...
      <div className="container">
        <div className="row  py-4">
          <div className="col mb-5">
            ...
            <img src={logo} alt="logo" height={150} style={{paddingTop:35, paddingBottom: 30}} />

            {/* </a> */}
            <p className="text-white text-start">This is a sample forum for Project CS422. If you’re interested in using it for your own purposes, please feel free to ask us.</p>
          </div>
